...
df_drugs_smiles = pd.read_csv('data/all_smile.csv')
...
def prepare(df_drug, feature_list, type, drugA, drugB,smileA,smileB):
    ...
    data = pd.read_csv(r'./data/fra_mc.csv')
    data = np.array(data)
    fra_feature = data[:, 1:]
